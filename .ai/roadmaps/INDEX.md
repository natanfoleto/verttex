...
| 014 | Estoque, Lotes, FEFO e Movimentações                 | `active`    | high       | 013           | [`active/014-inventory-and-stock-movements.md`](.ai/roadmaps/active/014-inventory-and-stock-movements.md)                 |
