...
| :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Severidade**       | 🔴 Crítico                                                                                                                                                                                                                                                                                                                                                                                |
| **Status**           | ✅ **RESOLVED** (Corrigido em `apps/api/src/shared/utils/crypto.ts`)                                                                                                                                                                                                                                                                                                                      |
| **Data de registro** | 2026-07-22                                                                                                                                                                                                                                                                                                                                                                                |
| **Arquivo**          | [`apps/api/src/shared/utils/crypto.ts`](../../apps/api/src/shared/utils/crypto.ts)                                                                                                                                                                                                                                                                                                        |
...
| **Evidência**        | `if (!storedHash.includes(':')) { return false }`                                                                                                                                                                                                                                                                                                                                         |
| **Impacto**          | Autenticação bypassada para usuários com hash sem formato correto                                                                                                                                                                                                                                                                                                                         |
| **Correção**         | Bloco legado removido; retorna `false` estritamente para hashes sem formato `salt:hash`.                                                                                                                                                                                                                                                                                                  |
...
| :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Severidade**       | 🟠 Alto                                                                                                                                                                             |
| **Status**           | ✅ **RESOLVED** (Implementado em `apps/api/src/plugins/rate-limit.ts`)                                                                                                              |
| **Data de registro** | 2026-07-22                                                                                                                                                                          |
| **Arquivo**          | [`apps/api/src/plugins/rate-limit.ts`](../../apps/api/src/plugins/rate-limit.ts)                                                                                                    |
...
| **Correção**         | Implementado `@fastify/rate-limit` com chaves independentes por IP e por conta.                                                                                                     |
...
| :------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Severidade**       | 🟠 Alto                                                                                                                                                                                                                |
| **Status**           | ✅ **RESOLVED** (Implementado em `apps/api/src/plugins/helmet.ts`)                                                                                                                                                     |
| **Data de registro** | 2026-07-22                                                                                                                                                                                                             |
| **Arquivo**          | [`apps/api/src/plugins/helmet.ts`](../../apps/api/src/plugins/helmet.ts)                                                                                                                                               |
...
| **Correção**         | Instalação e ativação do `@fastify/helmet` registrada no bootstrap do app (`app.ts`).                                                                                                                                  |
