  ...
  return (
    <>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-xs text-zinc-400">
                          Envie imagens de alta qualidade do produto artesanal.
                          A primeira imagem é a capa principal por padrão.
                        </p>
                      </div>
                    ...
                    {mediaItems.length > 0 ? (
                      ...
                      <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-zinc-800 bg-zinc-900/30 p-8 text-center">
                        ...
                        <p className="text-xs text-zinc-500 mt-1">
                          Carregue arquivos nos formatos JPG, PNG ou WebP de até
                          5 MB.
                        </p>
                      </div>
                    )}
      ...
      <ErrorDialog
        ...
        error={errorState}
        title="Atenção: Não foi possível salvar o produto"
        description="Verifique os detalhes e corrija os pontos indicados abaixo para continuar."
      />
    </>
  )
}
