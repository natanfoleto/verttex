...
export function ErrorDialog({
  ...
  onOpenChange,
  error,
  title = 'Atenção: Existem pendências no formulário',
  description = 'Não foi possível concluir a solicitação. Verifique os detalhes e corrija os campos indicados para continuar.',
}: ErrorDialogProps) {
