  ...
  const allProducts: CarouselProductItem[] =
    featuredProductsRes?.data && featuredProductsRes.data.length > 0
      ? featuredProductsRes.data.map((p) => ({
        ...
        installments: `3x R$ ${(
          (p.promotionalPrice || p.price) / 3
        ).toFixed(2).replace(".", ",")} com sua Linha de Crédito`,
    ...
    <div className="space-y-8 pb-20 lg:pb-28 font-sans antialiased">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-32">
        ...
        <ProductSectionCarousel
          ...
          products={section1Products.length > 0 ? section1Products : fallbackDemoProducts}
        />
        ...
        <ProductSectionCarousel
          ...
          products={section4Products.length > 0 ? section4Products : fallbackDemoProducts}
        />
...
const fallbackDemoProducts: CarouselProductItem[] = [
  {
    ...
    freeShipping: true,
    imageUrl: "https://images.unsplash.com/photo-1518455027359-f3f8164ba6bd?w=500&auto=format&fit=crop",
  },
  {
    id: "demo-2",
    ...
    benefitBadge: "20% OFF no Pix",
    freeShipping: true,
    imageUrl: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=500&auto=format&fit=crop",
  },
  {
    id: "demo-3",
    ...
    benefitBadge: "20% OFF no Pix",
    freeShipping: true,
    imageUrl: "https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?w=500&auto=format&fit=crop",
  },
  {
    id: "demo-4",
  ...
  },
  {
    ...
    benefitBadge: "20% OFF no Pix",
    freeShipping: true,
    imageUrl: "https://images.unsplash.com/photo-1505797149-43b0069ec26b?w=500&auto=format&fit=crop",
  },
  {
    id: "demo-6",
