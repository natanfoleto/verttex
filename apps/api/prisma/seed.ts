...
const rolesData = [
  ...
  },
  {
    ...
    description:
      "Gerente responsável pelo catálogo e operação da loja parceira",
    isSystem: false,
  },
  {
    key: "support_analyst",
...
const seedStoresData = [
  ...
  },
  {
    ...
    description: "Frutas, vegetais e grãos certificados livres de agrotóxicos.",
    status: "suspended",
...
async function main() {
  ...
  const auditEvents = [
    ...
    },
    {
      ...
      newValues: {
        description: "Cervejas vivas não filtradas com ingredientes locais",
      },
      ipAddress: "177.200.45.12",
      userAgent: "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_7)",
    },
    ...
    await prisma.auditLog.create({
      data: {
        ...
        oldValues: log.oldValues
          ? JSON.parse(JSON.stringify(log.oldValues))
          : undefined,
        newValues: log.newValues
          ? JSON.parse(JSON.stringify(log.newValues))
          : undefined,
  ...
  const catQueijos = await prisma.category.upsert({
    ...
    create: {
      ...
      description:
        "Queijos finos e artesanais produzidos em regiões tradicionais",
      position: 1,
      status: "active",
      isVisible: true,
    },
  ...
  await prisma.category.upsert({
    ...
    create: {
      ...
      description:
        "Doces de leite, geleias de frutas nativas e compotas tradicionais",
      position: 2,
      status: "active",
      isVisible: true,
    },
  ...
  console.log(
    "✅ Categorias, marcas e produtos de amostra semeadas com sucesso.",
  );
