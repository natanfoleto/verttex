...
export async function reportsRoutes(app: FastifyInstance) {
  ...
  typedApp.get(
    "/top-products",
    {
      ...
      schema: {
        tags: ["Reports & BI"],
        summary: "Obter ranking dos produtos mais vendidos e classificação na Curva ABC",
        security: [{ bearerAuth: [] }],
        querystring: dateRangeQuerySchema,
      },
    },
  ...
  typedApp.get(
    "/inventory-losses",
    {
      ...
      schema: {
        tags: ["Reports & BI"],
        summary: "Obter relatório de perdas sanitárias de estoque (descartes por avaria/vencimento)",
        security: [{ bearerAuth: [] }],
        querystring: dateRangeQuerySchema,
      },
    },
  ...
  typedApp.get(
    "/export",
    {
      ...
      schema: {
        tags: ["Reports & BI"],
        summary: "Exportar relatório de inteligência comercial em formato CSV ou JSON",
        security: [{ bearerAuth: [] }],
